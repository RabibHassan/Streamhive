...
<body>
    ...
    <div class="admin-container">
        <div class="admin-options">
            ...
            <form action="/admin_go" method="POST">
                @csrf
                <button class="admin_buttons" type="submit" name="decision" value="series">User Subscription</button>
            </form>
        </div>
        <div class="table-details">
            <table class="table">
                ...
                <tr>
                    ...
                    <th class="th1" scope="col">Delete</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td1">
                            <form action="/deletemovie" method="POST">
                                ...
                                <button type="submit" class="s_plan">Remove this</button>
                            </form>
                    </tr>
                @endforeach
                </tbody>
        ...
        <div>
            ...
            <form action="/addmovie" method="POST" enctype="multipart/form-data">
                ...
                <div class="input">
                    <input class="input_bar" type="file" id="img" name="img" accept="image/*" required>
                </div>
